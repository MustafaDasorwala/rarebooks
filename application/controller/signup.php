   ...
   /* public function UserDetails($first_name,$last_name,$email_address,$username,$password)
	   ...
	   public function AddUser()
    {
       ...
       // echo 'Message from Controller: You are in the Controller: Songs, using the method addSong().';
        ...
        if (isset($_POST["submit_add_user"])) 
        {
            ...
            $result =$signup_model->SubmitUser($_POST["fname"], $_POST["lname"],  $_POST["email"], $_POST["username"],  $_POST["pass"]);
          ...
          //?success=0
		  //zero is returned if error exists
		  }
	    ...
	    public function getUserName($uname)
    {
		...
		//$uname=$_REQUEST['username'];
		 ...
		 $signup_model = $this->loadModel('signupmodel');
            $result =$signup_model->CheckUser($uname);
